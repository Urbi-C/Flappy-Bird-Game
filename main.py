import random #for generating random numbers for pipes
import sys    #exiting game
import pygame
from pygame.locals import *  #Basic game imports
...
def mainGame():
	...
	while True:
		...
		#the above function will return true if the player is crashed
        ...
        #Add a new pipe when the first crosses out of screen
...
def getRandomPipe():
	'''Generate pipe positions (straight & Inverted)'''
	pipeHeight = GAME_SPRITES['pipe'][0].get_height() 
...
if __name__ == '__main__':
	#this is the start of the execution point
	pygame.init()  #Initialises all pygame modules
	FPSCLOCK=pygame.time.Clock() #used to control FPS
	pygame.display.set_caption("Flappy Bird by URBI")
...
while True:
	...
	mainGame() #main gameplay function
